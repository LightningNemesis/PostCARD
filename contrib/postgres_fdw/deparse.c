...
get_jointype_name(JoinType jointype)
{
	...
	default:
		...
		elog(ERROR, "M_deparse unsupported join type %d", jointype);
	}
 ...
 */
void deparseInsertSql(StringInfo buf, RangeTblEntry *rte,
					  Index rtindex, Relation rel,
 ...
 * which is returned to *retrieved_attrs.
 */
void deparseUpdateSql(StringInfo buf, RangeTblEntry *rte,
					  Index rtindex, Relation rel,
					  List *targetAttrs,
					  List *withCheckOptionList, List *returningList,
					  List **retrieved_attrs)
 ...
 * to *retrieved_attrs.
 */
void deparseDeleteSql(StringInfo buf, RangeTblEntry *rte,
					  Index rtindex, Relation rel,
					  List *returningList,
					  List **retrieved_attrs)
{
