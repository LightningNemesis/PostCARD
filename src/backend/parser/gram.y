...
%token <keyword> ABORT_P ABSENT ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	HANDLER HAVING HEADER_P HLL_JOIN HOLD HOUR_P
 ...
 */
%left		JOIN CROSS LEFT FULL RIGHT INNER_P NATURAL HLL_JOIN
...
joined_table:
			...
			| table_ref CROSS JOIN table_ref
				{
					elog(WARNING, "=== CROSS JOIN detected! ===");
			...
			| table_ref join_type JOIN table_ref join_qual
				{
					elog(WARNING, "=== INNER JOIN detected! ===");
					JoinExpr   *n = makeNode(JoinExpr);
			...
			| table_ref JOIN table_ref join_qual
				{
					elog(WARNING, "=== JOIN detected, WoooHoooo! ===");
			...
			| table_ref HLL_JOIN table_ref join_qual
				{
					JoinExpr   *n = makeNode(JoinExpr);
					elog(WARNING, "=== HLL JOIN detected! ===");
