						...
						List **namespace)
{
	...
	else if (IsA(n, JoinExpr))
	{
		...
		case JOIN_INNER:
			break;
		case JOIN_HLL: // Add this case - no special handling needed, like INNER JOIN
			break;
		case JOIN_LEFT:
		...
		default:
			...
			elog(ERROR, "M_transformFromClauseItem unrecognized join type: %d",
				 (int)j->jointype);
			break;
		}
				   ...
				   Var *l_colvar, Var *r_colvar)
{
	...
	default:
		elog(ERROR, "M_buildMergedJoinVar unrecognized join type: %d", (int)jointype);
